...
public class EmailService {
    ...
    public void sendVerificationEmail(String to, String name, String firstname, String token) {
        ...
        String confirmationUrl = "https://backendforum-production.up.railway.app/auth/verify?token=" + token;
   String message = "<html>" +
    ...
    private String generateConfirmationLink(String token){
        return "<a href=https://backendforum-production.up.railway.app/auth/verify?token="+token+">Confirm Email</a>";
    }
}
