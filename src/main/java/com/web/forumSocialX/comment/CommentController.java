...
public class CommentController {
    ...
    @GetMapping("/hierarchy/{commentId}")
    public ResponseEntity<List<Comment>> getCommentHierarchy(@PathVariable Long commentId) {
        List<Comment> hierarchy = commentService.getCommentHierarchy(commentId);
