package com.web.forumTunisia.email;
...
public class EmailService {
    ...
    public void sendVerificationEmail(String to, String name, String firstname, String token) {
        ...
        String confirmationUrl = "http://localhost:4200/api/auth/verify?token=" + token;
   String message = "<html>" +
                ...
                "<a href='" + generateConfirmationLink(token) + "' style='background-color: #3498db; color: white; padding: 10px 15px; text-decoration: none; border-radius: 5px;'>Confirmer mon compte</a>" +
    ...
    public void sendPasswordResetEmail(String to, String name, String firstname, String resetUrl) throws MessagingException {
    ...
    private String generateConfirmationLink(String token){
        return "<a href=http://localhost:4200/api/auth/verify?token="+token+">Confirm Email</a>";
    }
}
